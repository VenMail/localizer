...
const { getNamespaceFromFile, parseJsonText } = require('./lib/stringUtils');
...
const translationsPath = path.resolve(outputDir, `${sourceLocale}.json`);
...
(async () => {
  try {
    ...
    // Load grouped <outputDir>/<sourceLocale>/**/*.json if available
