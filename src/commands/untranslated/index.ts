...
export class UntranslatedCommands {
    ...
    async copyTranslationToDefaultLocale(
        ...
        return this.keyManagementHandler.copyTranslationToDefaultLocale(documentUri, key, sourceLocale, targetLocale, options);
    }

    async bulkFixMissingDefaultTranslations(documentUri: vscode.Uri): Promise<void> {
        return this.keyManagementHandler.bulkFixMissingDefaultTranslations(documentUri);
    }
}
